...
namespace ASP.netCoreWebAppMVC
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                ControllerEndpointRouteBuilderExtensions.MapControllerRoute(endpoints, name: "default", pattern: "{controller=Home}/{action=Index}/{id?}");
            });
        }
    }
}